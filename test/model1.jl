...
station1 = GeoStation(1, coord1, "test", false)
station2 = GeoStation(2, coord2, "test", false)
station3 = GeoStation(3, coord2, "test", false)
station4 = GeoStation(4, coord2, "test", false)
station5 = GeoStation(5, coord2, "test", false)
station6 = GeoStation(6, coord2, "test", false)
station7 = GeoStation(7, coord2, "test", false)
station8 = GeoStation(8, coord2, "test", false)
station9 = GeoStation(9, coord2, "test", false)
line1 = Line("S1")
line2 = Line("S2")
line3 = Line("S3")
line4 = Line("S4")
